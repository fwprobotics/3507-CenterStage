...
public class FieldActionSequence {
    ...
    public FieldActionSequence dropPurplePixel(Robot.PropLocation propLocation) {
        ...
        switch (propLocation) {
            ...
            case RIGHT:
                builder = builder
                        .splineToLinearHeading(new Pose2d(35*autoZoneColor.xMult, 31+ autoZoneHalf.yOffset, Math.toRadians(90)), Math.toRadians(0))
                        .waitSeconds(1);
                break;
        }
        return this;
    ...
    public FieldActionSequence dropYellowPixel(Robot.PropLocation propLocation) {
        builder = builder
                ...
                .splineTo(new Vector2d((((autoZoneColor.xMult <0) ? 40 : 30 )* autoZoneColor.xMult)+(propLocation.offset* autoZoneColor.xMult), 50), Math.toRadians(90));
        return this;
    }
